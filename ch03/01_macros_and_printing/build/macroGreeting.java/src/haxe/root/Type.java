	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		
		{
			...
			switch (__temp_hash38)
			{
				...
				{
					if (( (( ( __temp_hash38 == -672261858 ) && __temp_svar36.equals("Integer") )) || __temp_svar36.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar36.equals("Object")) 
					{
						__temp_executeDef37 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash38 == 2052876273 ) && __temp_svar36.equals("Double") )) || __temp_svar36.equals("double") )) 
					{
						__temp_executeDef37 = false;
						return "Float";
					}
